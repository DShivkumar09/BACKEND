...
from .models import Country, City, User, State,BankInformation
...
class Bank_Details(admin.ModelAdmin):
    list_display=['bank_name', 'bank_ifsc_code','bank_address','bank_account_number','branch_name','user']